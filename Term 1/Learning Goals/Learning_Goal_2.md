...
```mermaid
gantt
    title Learning Goal 2 - Timeline
    dateFormat YYYY-MM-DD
    axisFormat %b %d

    section Explore
    Read up on the topic        :a1, 2027-02-01, 14d
    Pick tools and approach     :a2, after a1, 7d

    section Build
    First working version       :b1, after a2, 21d
    Test and get feedback       :b2, after b1, 14d

    section Finish
    Improve based on feedback   :c1, after b2, 14d
    Write up the result         :c2, after c1, 7d
```
